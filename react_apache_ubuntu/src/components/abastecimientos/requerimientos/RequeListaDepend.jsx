              ...
              >
                <thead>
                  <tr className="color-header1 text-white">
                    ...
                    <th className="text-center align-middle m-0 p-0">Monto</th>
                ...
                <tbody>
                  {requerimientos.map((requerimiento, i) => (
                    <tr
                      key={`${requerimiento.C_reque}-${requerimiento.C_biesertipo}`}
                    >
                      <RequeListaDependItemComponent
