...
export default function PreLicenciaNRComponent({precalId, verPrecalificacion}) {
      ...
      <div>
        ...
        >
          ...
          <Modal.Body>
            ...
            <Form.Group className="mb-3" controlId="formBasicEmail">
              <Form.Label className="fw-bold">Nivel de riesgo</Form.Label>
              <Form.Select aria-label="Default select example" ref={selectNivRie
              }>
