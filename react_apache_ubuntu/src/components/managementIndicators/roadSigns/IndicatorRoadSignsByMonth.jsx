...
export const IndicatorRoadSignsByMonth = ({ monthlyData = [], year = 0 }) => {
    const dafaultOption = useMemo(
        () => {
            const montos = monthlyData.length > 0 
                ? monthlyData.map(item => item.cantidad) 
    ...
    return (
        <div className="bg-white rounded-4 shadow-sm p-4 h-100">
            <div className="d-flex justify-content-between align-items-start mb-2">
                <div>
                    <h6 className="fw-semibold text-secondary mb-1">Evolución de las señalizaciones por mes</h6>
                </div>
