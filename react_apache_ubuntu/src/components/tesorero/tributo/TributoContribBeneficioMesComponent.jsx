...
import { TributoContribBeneficioItemComponent } from "./TributoContribBeneficioItemComponent";

export const TributoContribBeneficioMesComponent = ({
  C_Contrib,
  N_Contrib,
  C_TipOpe,
  N_TipOpe,
