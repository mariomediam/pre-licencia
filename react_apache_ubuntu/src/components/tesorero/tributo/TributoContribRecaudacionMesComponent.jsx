...
// import { TributoContribRecaudstemComponent } from "./TributoContribRecaudsItemComponent";
...
export const TributoContribRecaudacionMesComponent = ({
  C_Contrib,
  N_Contrib,
  C_TipOpe,
  N_TipOpe,
