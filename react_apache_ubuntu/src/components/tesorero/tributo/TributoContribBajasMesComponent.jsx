...
import { TributoContribBajastemComponent } from "./TributoContribBajasItemComponent";

export const TributoContribBajasMesComponent = ({
  C_Contrib,
  N_Contrib,
  C_TipOpe,
  N_TipOpe,
            ...
            >
              ...
              <tbody>
                {listTributo.map((tributo, index) => (
                  <TributoContribBajastemComponent
